...
class CodeEditor(ctk.CTk):
    ...
    def _open_file(self, event=None):
        path = filedialog.askopenfilename(filetypes=[("Text Files", "*.txt"), ("exc1 Files", "*.exc1"), ("All Files", "*")])
        if path:
            try:
    ...
    def _run_file(self):
        ...
        # Main help text
        help_label = ctk.CTkLabel(main_frame, text="The compiler is in progress. Can't be usen now", wraplength=250, justify="center", text_color="#FF0000")
